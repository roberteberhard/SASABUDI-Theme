...
/**
 * RightPress Fix
 * Failproof alternative to server's /tmp directory - WordPress uploads directory
 */
...
define ('K_PATH_CACHE', $temp_location.'/');
 ...
 */
define ('PDF_FONT_NAME_MAIN', 'rightpressnotosans');
 ...
 */
define ('PDF_FONT_NAME_DATA', 'rightpressnotosans');
 ...
 */
define ('PDF_IMAGE_SCALE_RATIO', 1.53);
