...
<table id="template_content" style="padding:0 40px;" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td valign="top" style="padding-bottom:20px;">
			...
			<p style="margin:0;text-align:center;font-family:'Helvetica',Arial,Verdana,sans-serif;color:#202020;font-size:18px;line-height:1.5;"><?php esc_html_e( 'We have finished processing your order.', 'woocommerce' ); ?></p>
		</td>
	</tr>
	<tr>
		<td valign="top">
