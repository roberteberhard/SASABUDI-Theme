          ...
          echo '<div class="sitemap-row">';
            ...
            echo '<div class="sitemap-col">';
              ...
              echo '<ul class="sitemap-list">';
                ...
                echo '<li><a href="' . esc_url(home_url('/catalog/new-arrivals/?orderby=date')) . '">' . esc_html('New Arrivals', 'sasabudi') . '</a></li>';
                echo '<li><a href="' . esc_url(home_url('/catalog/exclusive/')) . '">' . esc_html('On Our Radar', 'sasabudi') . '</a></li>';
