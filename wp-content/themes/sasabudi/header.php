...
<?php wp_head(); ?>	
<?php if (is_page ('contact')) { ?><script type="text/javascript" src="https://www.google.com/recaptcha/api.js?onload=onCaptchaCallback" async defer></script><?php } ?>
...
echo '<div id="app" class="app' . $promotion_state . ' modal-off">';
  ...
  echo '<header class="header-desktop">';
    echo '<div class="header-desktop__wrapper">';
      ...
      */
    do_action( 'sasabudi_header_desktop_navigation' );
 ...
 echo '</header>';
   ...
   * @hooked :: sasabudi_header_device_promotion - 20
   */
  do_action( 'sasabudi_header_device_note' );
